  ...
  <section className="relative h-screen w-full mt-32">
    <div className="overflow-hidden relative rounded-lg m-12 h-full  bg-white">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white ">
        <h1 className="text-4xl md:text-7xl font-bold mb-4 bg-purple-500">
        Contactez notre établissement
        </h1>
        <p className="text-base md:text-lg max-w-5xl leading-relaxed mb-6 text-gray-200  bg-purple-500">
          Un message pour notre établissement est une communication écrite ou orale visant à transmettre une information, une demande ou une annonce de manière claire et professionnelle.
          <br /><br />
          Que ce soit pour une question administrative, une inscription, une réclamation ou une simple information, nous vous invitons à formuler votre message de façon concise et polie, en précisant l'objet de votre demande.
          <br /><br />
          Pour une réponse optimale, privilégiez les canaux officiels (email, formulaire en ligne, accueil physique) et indiquez vos coordonnées ainsi que toute pièce jointe utile. Nous nous engageons à traiter votre demande dans les meilleurs délais.
          <br /><br />
          <span className="italic text-gray-100">
            Exemple : "Bonjour, je souhaite obtenir un duplicata de mon certificat de scolarité. Comment procéder ? Cordialement, [Prénom Nom]."
          </span>
          <br /><br />
          Pour nous contacter, utilisez notre formulaire dédié ou l’adresse mail indiquée dans la rubrique "Contact". Merci pour votre compréhension.
        </p>
