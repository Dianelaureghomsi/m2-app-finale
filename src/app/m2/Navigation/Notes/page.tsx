  ...
  <section className="py-16 bg-white">
    <div className="container mx-auto px-6">
      ...
      <div className="flex flex-col justify-center gap-8">
        <FeatureCard
          title="Liste pour tout l'établissement"
          description="Accédez à la liste des meilleurs élèves de l'établissement."
          icon={<ChartColumn size={40} />}
          imageSrc="/images/school.jpeg"
        />
        <FeatureCard
          title="Liste par Niveau"
          description="Accédez à la liste des meilleurs élèves par niveau (6ème, 5ème, 4ème, etc)."
          icon={<ChartColumn size={40} />}
          imageSrc="/images/niveau.jpg"
        />
      </div>
    </div>
  </section>
